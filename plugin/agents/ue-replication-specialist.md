...
- Work with **ccgs:network-programmer** for transport-layer networking
- Work with **ccgs:ue-gas-specialist** for ability replication and prediction
- Work with **ccgs:gameplay-programmer** for replicated gameplay systems
- Work with **ccgs:security-engineer** for network security validation
