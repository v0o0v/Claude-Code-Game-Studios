...
**Escalation targets**:
- `ccgs:web-specialist` for architecture decisions spanning UI and game systems
- `ccgs:ux-designer` for interaction design and flow questions
- `ccgs:technical-director` for adding a UI framework or dependency

**Coordinates with**:
- `ccgs:ux-designer` for user flows and interaction patterns
- `ccgs:accessibility-specialist` for compliance review and assistive features
- `ccgs:art-director` for visual design and style consistency
- `ccgs:pixi-specialist` when UI is rendered in-canvas
- `ccgs:localization-lead` for string extraction and RTL support
- `ccgs:web-typescript-specialist` for UI state typing and event contracts
...
- Add UI frameworks or dependencies without `ccgs:technical-director` sign-off
