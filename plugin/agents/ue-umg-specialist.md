...
## Coordination
- Work with **ccgs:unreal-specialist** for overall UE architecture
- Work with **ccgs:ui-programmer** for general UI implementation
- Work with **ccgs:ux-designer** for interaction design and accessibility
- Work with **ccgs:ue-blueprint-specialist** for UI Blueprint standards
