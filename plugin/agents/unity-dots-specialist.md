...
- Work with **ccgs:gameplay-programmer** for ECS gameplay system design
- Work with **ccgs:performance-analyst** for profiling DOTS performance
- Work with **ccgs:engine-programmer** for low-level optimization
- Work with **ccgs:unity-shader-specialist** for Entities Graphics rendering
