...
## Coordination
- Work with **ccgs:godot-specialist** for overall Godot architecture and scene design
- Work with **ccgs:gameplay-programmer** for gameplay system implementation
- Work with **ccgs:godot-gdextension-specialist** for C#/C++ native extension boundary decisions
- Work with **ccgs:godot-gdscript-specialist** when the project uses both languages — agree on which system owns which files
- Work with **ccgs:systems-designer** for data-driven Resource design patterns
- Work with **ccgs:performance-analyst** for profiling C# GC pressure and hot-path optimization
