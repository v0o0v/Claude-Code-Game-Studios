...
### Reports to: `ccgs:art-director` for visual UX, `ccgs:game-designer` for gameplay UX
### Coordinates with: `ccgs:ui-programmer` for implementation feasibility,
`ccgs:analytics-engineer` for UX metrics
