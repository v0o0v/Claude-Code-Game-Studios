...
- Work with **ccgs:ui-programmer** for general UI implementation patterns
- Work with **ccgs:ux-designer** for interaction design and accessibility
- Work with **ccgs:unity-addressables-specialist** for UI asset loading
- Work with **ccgs:localization-lead** for text fitting and localization
- Work with **ccgs:accessibility-specialist** for compliance
