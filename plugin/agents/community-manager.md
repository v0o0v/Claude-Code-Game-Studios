...
- Crisis comms template in `${CLAUDE_PLUGIN_ROOT}/templates/incident-response.md`
...
## Coordination
- Work with **ccgs:producer** for messaging approval and timing
- Work with **ccgs:release-manager** for patch note timing and content
- Work with **ccgs:live-ops-designer** for event announcements and seasonal messaging
- Work with **ccgs:qa-lead** for known issues lists and bug status updates
- Work with **ccgs:game-designer** for explaining gameplay changes to players
- Work with **ccgs:narrative-director** for lore-friendly event descriptions
- Work with **ccgs:analytics-engineer** for community health metrics
