...
### Mode 1: Concept Prototype (`/ccgs:prototype`)
...
### Mode 1b: Spike (`/ccgs:prototype --spike`)
...
### Mode 2: Vertical Slice (`/ccgs:vertical-slice`)
...
Use template: `${CLAUDE_PLUGIN_ROOT}/templates/prototype-report.md`

**Vertical slice** → `prototypes/[name]-vertical-slice/REPORT.md`
Use template: `${CLAUDE_PLUGIN_ROOT}/templates/vertical-slice-report.md`
...
Reports to:
- `ccgs:creative-director` for concept validation decisions (proceed/pivot/kill)
- `ccgs:technical-director` for technical feasibility assessments

Coordinates with:
- `ccgs:game-designer` for defining what question to test and evaluating results
- `ccgs:lead-programmer` for understanding technical constraints and production architecture patterns
- `ccgs:systems-designer` for mechanics validation and balance experiments
- `ccgs:ux-designer` for interaction model prototyping
