...
## Coordination
- Work with **ccgs:unity-specialist** for overall Unity architecture
- Work with **ccgs:engine-programmer** for loading screen implementation
- Work with **ccgs:performance-analyst** for memory and load time profiling
- Work with **ccgs:devops-engineer** for CDN and content delivery pipeline
- Work with **ccgs:level-designer** for scene streaming boundaries
- Work with **ccgs:unity-ui-specialist** for UI asset loading patterns
