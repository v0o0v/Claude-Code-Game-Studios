...
## Coordination
- Work with **ccgs:unreal-specialist** for general UE architecture decisions
- Work with **ccgs:gameplay-programmer** for ability implementation
- Work with **ccgs:systems-designer** for ability design specs and balance values
- Work with **ccgs:ue-replication-specialist** for multiplayer ability prediction
- Work with **ccgs:ue-umg-specialist** for ability UI (cooldown indicators, buff icons)
