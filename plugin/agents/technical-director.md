...
- Write gameplay code directly (delegate to ccgs:lead-programmer)
- Manage sprint schedules (delegate to ccgs:producer)
- Approve or reject game design (delegate to ccgs:game-designer)
