...
- Work with **ccgs:godot-gdscript-specialist** for GDScript/native boundary decisions
- Work with **ccgs:engine-programmer** for low-level optimization
- Work with **ccgs:performance-analyst** for profiling native vs GDScript performance
- Work with **ccgs:devops-engineer** for cross-platform build pipelines
- Work with **ccgs:godot-shader-specialist** for compute shader vs native alternatives
