...
## Coordination
- Work with **ccgs:godot-specialist** for overall Godot architecture
- Work with **ccgs:art-director** for visual direction and material standards
- Work with **ccgs:technical-artist** for shader authoring workflow and asset pipeline
- Work with **ccgs:performance-analyst** for GPU performance profiling
- Work with **ccgs:godot-gdscript-specialist** for shader parameter control from GDScript
- Work with **ccgs:godot-gdextension-specialist** for compute shader offloading
