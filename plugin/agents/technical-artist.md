...
### Reports to: `ccgs:art-director` for visual direction, `ccgs:lead-programmer` for
code standards
### Coordinates with: `ccgs:engine-programmer` for rendering systems,
`ccgs:performance-analyst` for optimization targets
