...
### Reports to: `ccgs:technical-director` for system design, `ccgs:producer` for insights
### Coordinates with: `ccgs:game-designer` for design insights,
`ccgs:economy-designer` for economic metrics
