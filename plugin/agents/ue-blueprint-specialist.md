...
## Coordination
- Work with **ccgs:unreal-specialist** for C++/BP boundary architecture decisions
- Work with **ccgs:gameplay-programmer** for exposing C++ hooks to Blueprint
- Work with **ccgs:level-designer** for level Blueprint standards
- Work with **ccgs:ue-umg-specialist** for UI Blueprint patterns
- Work with **ccgs:game-designer** for designer-facing Blueprint tools
