...
**Quality Checks:**
- [ ] Full QA pass signed off by `ccgs:qa-lead`
- [ ] All tests passing
...
1. **`ccgs:creative-director`** — gate **CD-PHASE-GATE** (`${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md`)
2. **`ccgs:technical-director`** — gate **TD-PHASE-GATE** (`${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md`)
3. **`ccgs:producer`** — gate **PR-PHASE-GATE** (`${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md`)
4. **`ccgs:art-director`** — gate **AD-PHASE-GATE** (`${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md`)
...
- **Missing design docs?** → `/ccgs:reverse-document` or delegate to `ccgs:game-designer`
...
- **Tests failing?** → delegate to `ccgs:lead-programmer` or `ccgs:qa-tester`
...
- **No Difficulty Curve doc?** → Create `design/difficulty-curve.md` from the template at `${CLAUDE_PLUGIN_ROOT}/templates/difficulty-curve.md` — or use `/ccgs:quick-design "difficulty curve"` for a guided session.
- **No player journey map?** → Create `design/player-journey.md` from the template at `${CLAUDE_PLUGIN_ROOT}/templates/player-journey.md` — or author it collaboratively using `/ccgs:ux-design` Phase 2b.
