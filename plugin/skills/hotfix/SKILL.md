...
After approvals, determine the QA scope required before deploying the hotfix. Spawn `ccgs:qa-lead` via Task with:
...
- If the fix is complex enough to need more than 4 hours, escalate to `ccgs:technical-director`
