...
|------|----------|-------------|
| `design` | `${CLAUDE_PLUGIN_ROOT}/templates/design-doc-from-implementation.md` | `design/gdd/[system-name].md` |
| `architecture` | `${CLAUDE_PLUGIN_ROOT}/templates/architecture-doc-from-code.md` | `docs/architecture/[decision-name].md` |
| `concept` | `${CLAUDE_PLUGIN_ROOT}/templates/concept-doc-from-prototype.md` | `prototypes/[name]/CONCEPT.md` or `design/concepts/[name].md` |
