...
After all epics for the current layer are defined (Step 4 completed for all in-scope systems), and before writing any files, spawn `ccgs:producer` via Task using gate **PR-EPIC** (`${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md`).
