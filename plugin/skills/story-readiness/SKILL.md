...
See `${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md` for the full check pattern and mode definitions.
...
Spawn `ccgs:qa-lead` via Task using gate **QL-STORY-READY** (`${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md`).
