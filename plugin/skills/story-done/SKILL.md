...
After completing the deviation checks in Phase 4, spawn `ccgs:qa-lead` via Task using gate **QL-TEST-COVERAGE** (`${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md`).
...
Spawn `ccgs:lead-programmer` via Task using gate **LP-CODE-REVIEW** (`${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md`).
