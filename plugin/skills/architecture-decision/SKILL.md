...
5.6. **Technical Director Strategic Review** — After the engine specialist validation, spawn `ccgs:technical-director` via Task using gate **TD-ADR** (`${CLAUDE_PLUGIN_ROOT}/docs/director-gates.md`):
