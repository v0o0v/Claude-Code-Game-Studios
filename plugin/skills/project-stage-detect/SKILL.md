...
- `/ccgs:setup-tool` — if spec is missing
- `/ccgs:reverse-document` — if spec should be generated from existing code
- `/ccgs:code-review tools/` — if code quality hasn't been reviewed
- `/ccgs:architecture-decision` — if key design choices are undocumented
...
Use template: `${CLAUDE_PLUGIN_ROOT}/templates/project-stage-report.md`
