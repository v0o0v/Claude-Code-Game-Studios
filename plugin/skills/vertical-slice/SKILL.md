...
Read `${CLAUDE_PLUGIN_ROOT}/templates/vertical-slice-report.md` to get the report structure.
...
- `full` → spawn `ccgs:creative-director` via Task using gate **CD-PLAYTEST**
