...
## Team Composition
- **ccgs:ux-designer** — User flows, wireframes, accessibility, input handling
- **ccgs:ui-programmer** — UI framework, screens, widgets, data binding, implementation
- **ccgs:art-director** — Visual style, layout polish, consistency with art bible
...
- **ccgs:accessibility-specialist** — Audits accessibility compliance at Phase 4
...
Delegate to **ccgs:ui-programmer**:
...
- **ccgs:ux-designer**: Verify implementation matches wireframes and interaction spec. Test keyboard-only and gamepad-only navigation. Check accessibility features function correctly.
- **ccgs:art-director**: Verify visual consistency with art bible. Check at minimum and maximum supported resolutions.
- **ccgs:accessibility-specialist**: Verify compliance against the committed accessibility tier documented in `design/accessibility-requirements.md`. Flag any violations as blockers.
...
delegated to sub-agents and sub-skills (`/ccgs:ux-design`, `ccgs:ui-programmer`). Each enforces the
